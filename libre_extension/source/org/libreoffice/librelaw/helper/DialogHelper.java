...
import org.libreoffice.librelaw.helper.Lo; //LibreOffice utilities
...
public class DialogHelper {
	...
	public static void addListelement(XDialog dialog, String componentId,String textelem, int pos){
		XListBox lister = getListBox(dialog,componentId);
		lister.addItem(textelem,(short)pos); //needs short type for position index
	}

//Only full paths for directory
	public static void addListmass(XDialog dialog, String componentId,String directory, int pos){
		XListBox lister = getListBox(dialog,componentId);
    ...
    for (int i = 0; i < listOfFiles.length; i++) {
      if (listOfFiles[i].isFile()) {
				lister.addItem(listOfFiles[i].getAbsolutePath(),(short)(i+pos));
